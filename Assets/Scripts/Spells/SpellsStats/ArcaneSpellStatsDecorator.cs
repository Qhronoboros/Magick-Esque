...
{
    public ArcaneSpellStatsDecorator(string name, float size, int damage, Color color)
    ...
    public override IPrototype Clone() => new ArcaneSpellStatsDecorator(_name, _size, _damage, _color);
}
